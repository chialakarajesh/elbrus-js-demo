define('home.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var template = Handlebars.template({"1":function(depth0,helpers,partials,data,depths) {
  ...
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = " <p class=\"home-banner-top-message-1\"><strong>SCADEMO</strong> for <strong>GIT</strong> off checking details </p><div class=\"home\"><div class=\"home-banner-top\"><p class=\"home-banner-top-message\"> "
